...
const MaleBeginnerBodyweightSquats = () => {
  const benefits = [
    {
            ...
            <div className="sc-cta-card">
              <div className="sc-cta-content">
                ...
                <div className="sc-cta-buttons">
                  <Link href="/male-beginner-tasks/5-minute-warm-up" className="sc-btn-secondary">Previous: 5-Minute Warm-Up</Link>
                  <Link href="/male-beginner-tasks/push-ups" className="sc-btn-primary">Next: Modified Push-Ups</Link>
                </div>
              </div>
            </div>
          </div>
...
export default MaleBeginnerBodyweightSquats;
